...
function cooline.VARIABLES_LOADED()
	...
	cooline.tick0 = cooline.label('', 0, 'LEFT')
	cooline.tick1 = cooline.label('', cooline.section)
	cooline.tick3 = cooline.label('', cooline.section * 2)
	cooline.tick10 = cooline.label('', cooline.section * 3)
	cooline.tick30 = cooline.label('', cooline.section * 4)
	cooline.tick120 = cooline.label('', cooline.section * 5)
	cooline.tick300 = cooline.label('', cooline.section * 6, 'RIGHT')
